...
class Toolbox extends Component<Props> {
    ...
    constructor(props: Props) {
        ...
        this._onToolbarToggleSpatialAudio = this._onToolbarToggleSpatialAudio.bind(this);
    ...
    /**
     * Dispatches an action to toggle tile view.
     *
     * @private
     * @returns {void}
     */
    ...
    /**
     * Dispatches an action to toggle spatial audio.
     *
     * @private
     * @returns {void}
     */
    _doToggleSpatialAudio() {
    ...
    */
    ...
    _onToolbarToggleSpatialAudio: () => void;
     ...
     * @returns {void}
     */
    _onToolbarToggleSpatialAudio() {
        sendAnalytics(createToolbarEvent(
            'toggle.spatial',
                {
                    enable: !this.props._spatialAudioEnabled
                }));
        this._doToggleSpatialAudio();
    }
    ...
    _getAdditionalButtons(buttons) {
        ...
        if (this._shouldShowButton('spatial')) {
            buttons.has('spatial')
                ? mainMenuAdditionalButtons.push(
                    <SpatialAudioButton
                        key = 'spatial'
                        showLabel = { false }
                        toggled = { window.spatialAudio } />)
                : overflowMenuAdditionalButtons.push(
                    <SpatialAudioButton
                        key = 'spatial'
                        showLabel = { true } />);
