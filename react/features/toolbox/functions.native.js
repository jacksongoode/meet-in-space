...
export function getMovableButtons(width: number): Set<string> {
    ...
    case width >= WIDTH.FIT_9_ICONS: {
        buttons = [ 'togglecamera', 'chat', 'invite', 'raisehand', 'tileview', 'spatial' ];
        break;
    }
    case width >= WIDTH.FIT_8_ICONS: {
        buttons = [ 'chat', 'togglecamera', 'raisehand', 'tileview', 'spatial' ];
        break;
    }

    case width >= WIDTH.FIT_7_ICONS: {
        buttons = [ 'chat', 'togglecamera', 'raisehand', 'spatial' ];
        break;
    }
