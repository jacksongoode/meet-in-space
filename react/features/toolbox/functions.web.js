...
export function getToolbarAdditionalButtons(width: number, isMobile: boolean): Set<string> {
    ...
    case width >= WIDTH.FIT_9_ICONS: {
        buttons = isMobile
            ...
            : [ 'desktop', 'chat', 'raisehand', 'tileview', 'invite', 'spatial', 'overflow' ];
        break;
    }

    case width >= WIDTH.FIT_8_ICONS: {
        buttons = [ 'desktop', 'chat', 'raisehand', 'invite', 'spatial', 'overflow' ];
        break;
    }

    case width >= WIDTH.FIT_7_ICONS: {
        buttons = [ 'desktop', 'chat', 'invite', 'spatial', 'overflow' ];
        break;
    }
